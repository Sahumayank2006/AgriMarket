...
export const content = {
  en: {
    ...
    impactStats: [
      { icon: Shield, value: "8-Layer", label: "Octa-512 bit Encryption", labelKey: "encryption" },
      { icon: CircleDot, value: "OTH", label: "One-Time Handshake", labelKey: "oth" },
      { icon: Cloud, value: "99.9%", label: "Cloud Based Serivce", labelKey: "cloud_service" },
    ],
